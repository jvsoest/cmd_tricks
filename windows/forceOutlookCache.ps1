...
# Force explorer.exe to open in recent location instead of loading network locations
Set-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name Launchto -Value 2 -Force
